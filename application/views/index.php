                            ...
                            <div class="banner-info">
                                <div class="container">
                                    <div class="banner-info-bg">
                                        ...
                                        <a class="btn btn-style btn-primary mt-xl-5 mt-4 mr-2" href="<?php echo base_url('index.php/Onlinecontroller/About') ?>"> Get
                                            Started <span class="fa fa-chevron-right ml-2"
                                                aria-hidden="true"></span></a>
                                        <a class="btn btn-style btn-white mt-xl-5 mt-4" href="<?php echo base_url('index.php/Onlinecontroller/services') ?>"> View
        ...
        <div class="container py-lg-5 py-md-4">
            ...
            <div class="row top-pics ">
                <div class="col-lg-3 col-md-6 mt-5">
                    <div class="top-pic1">
                        <div class="card-body blog-details">
                            ...
                            <a href="<?php echo base_url('index.php/Onlinecontroller/services') ?>" class="blog-desc">Business
                            </a>
                            <div class="author align-items-center">
                                <img src="<?php base_url() ?>assets/images/admin.jpg" alt="" class="img-fluid rounded-circle">
                                <ul class="blog-meta">
                                    <ul class="blog-meta">
                ...
                <div class="col-lg-3 col-md-6 mt-5">
                    <div class="top-pic2">
                        <div class="card-body blog-details">
                            ...
                            <a href="<?php echo base_url('index.php/Onlinecontroller/services') ?>" class="blog-desc">Creative Art
                            </a>
                            <div class="author align-items-center">
                                <img src="<?php base_url() ?>assets/images/admin.jpg" alt="" class="img-fluid rounded-circle">
                                <ul class="blog-meta">
                ...
                <div class="col-lg-3 col-md-6 mt-5">
                    <div class="top-pic3">
                        <div class="card-body blog-details">
                            ...
                            <a href="<?php echo base_url('index.php/Onlinecontroller/services') ?>" class="blog-desc">Development
                            </a>
                            <div class="author align-items-center">
                                <img src="<?php base_url() ?>assets/images/admin.jpg" alt="" class="img-fluid rounded-circle">
                                <ul class="blog-meta">
                ...
                <div class="col-lg-3 col-md-6 mt-5">
                    <div class="top-pic4">
                        <div class="card-body blog-details">
                            ...
                            <a href="<?php echo base_url('index.php/Onlinecontroller/services') ?>" class="blog-desc">Photography
                            </a>
                            <div class="author align-items-center">
                                <img src="<?php base_url() ?>assets/images/admin.jpg" alt="" class="img-fluid rounded-circle">
                                <ul class="blog-meta">
                ...
                <div class="readhny-btm text-center mx-auto mt-md-4">
                    <a class="btn btn-primary btn-style mt-md-5 mt-4" href="<?php echo base_url('index.php/Onlinecontroller/About') ?>">Read More <span
                    ...
                    <div class="area-box">
                        <div class="row">
                            ...
                            <div class="col-sm-10 area-box-info">
                                ...
                                <a class="btn btn-primary btn-style mt-4" href="<?php echo base_url('index.php/Onlinecontroller/About') ?>">Start today <span class="fa fa-chevron-right ml-2" aria-hidden="true"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container pt-lg-2 pb-lg-4 py-4">
            <div class="welcome-left text-center py-lg-4">
                ...
                <div class="middle-buttons pb-5">
                    <a href="<?php echo base_url('index.php/Onlinecontroller/About') ?>" class="btn btn-style btn-white mt-sm-5 mt-4 mr-2">Read More <span
                            class="fa fa-chevron-right ml-2" aria-hidden="true"></span></a>
                    <a href="<?php echo base_url('index.php/Onlinecontroller/Contact') ?>" class="btn btn-style btn-primary mt-sm-5 mt-4">Contact Us <span
                            class="fa fa-chevron-right ml-2" aria-hidden="true"></span></a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 item">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="<?php echo base_url() ?>blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full" src="<?php echo base_url() ?>assets/images/ab8.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body blog-details">
                            <a href="<?php echo base_url() ?>blog-single.html" class="blog-desc">Learning to Write as a Professional Author
                            </a>
                            <div class="author align-items-center">
                                <img src="<?php echo base_url() ?>assets/images/admin.jpg" alt="" class="img-fluid rounded-circle">
                                <ul class="blog-meta">
                                    <li>
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="<?php echo base_url() ?>blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full" src="<?php echo base_url() ?>assets/images/ab2.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body blog-details">
                            <a href="<?php echo base_url() ?>blog-single.html" class="blog-desc">Learning to Write as a Professional Author</a>
                            <div class="author align-items-center">
                                <img src="<?php echo base_url() ?>assets/images/admin.jpg" alt="" class="img-fluid rounded-circle">
                                <ul class="blog-meta">
                                    <li>
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="<?php echo base_url() ?>blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full" src="<?php echo base_url() ?>assets/images/ab6.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body blog-details">
                            <a href="<?php echo base_url() ?>blog-single.html" class="blog-desc">Learning to Write as a Professional Author
                    ...
                    <div id="owl-demo1" class="owl-two owl-carousel owl-theme mb-md-3 mb-sm-5 mb-4">
                        <div class="item">
                            <div class="testimonial-content">
                                ...
                                <div class="testi-des">
                                    <div class="test-img">
                                        <img src="<?php base_url() ?>assets/images/team1.jpg" class="img-fluid" alt="client-img">
                                    </div>
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="<?php base_url() ?>assets/images/team2.jpg" class="img-fluid"
                                        alt="client-img">
                                </div>
                                    <div class="peopl align-self">
                                        <h4>Tommy sakura</h4>
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="<?php base_url() ?>assets/images/team3.jpg" class="img-fluid"
                                        alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h4>Bruce Bailey </h4>
